        ...
        <>
            ...
            <div className="min-h-screen bg-amber-50 dark:text-black">
                ...
                <main>
                    ...
                    <section
                        id="sobre-mi"
                        className="grid items-center gap-8 bg-amber-50 px-6 py-16 text-black sm:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-12 lg:px-20 lg:py-24 xl:px-40"
                    >
                        ...
                        <div className="flex flex-col items-center gap-10 px-4 py-10 sm:px-6 lg:px-20 lg:py-20">
                            ...
                            <div className="w-full md:hidden">
                                <div className="flex flex-col justify-between gap-5 rounded-3xl bg-cyan-200 p-6 shadow-sm drop-shadow-lg">
                                    <p>
                                        Recomiendo mucho las clases con la
                                        Jedah. Ella es muy divertida, simpática
                                        y muy cercana y eso hace que uno se
                                        sienta muy cómoda y pueda bajar la
                                        guardia y aprender tranquila. Te quiero
                                        mucho Jedah jaja! Nunca dejes de ser
                                        buena pa la talla y cercana porque eso a
                                        mí me ayuda mucho con la confianza en mí
                                        misma! Tomen clases con ella, no se van
                                        a arrepentir y así evitan botar plata
                                        con otra genteeeeeee! Muchas gracias
                                        porque contigo he aprendido lo que nunca
                                        he podido aprender con nadie más, ni
                                        siquiera en el colegio jajaja! Sigo
                                        contigo ❤️ !
                                    </p>
                            ...
                            <div className="hidden w-full md:grid md:grid-cols-2 md:gap-6 lg:gap-10 xl:grid-cols-3">
                                ...
                                <div className="flex flex-col justify-between gap-5 rounded-3xl bg-rose-200 p-6 shadow-sm drop-shadow-lg">
                                    <p>
                                        ...
                                        maravillosas, me encantan 💕. Leer un
                                        libro en Inglés ha sido un desafío
                                        enorme pero a la vez enriquecedor, me ha
                                        permitido aprender más vocabulario y
                                        también disfrutar la lectura. Compartir
                                        con otras personas sobre lo que leemos
                                        ha sido una forma más entretenida de ir
                                        aprendiendo y avanzando con el inglés,
                                        especialmente con el Speaking.
                                    </p>
                                    <div className="flex flex-row gap-5">
                                        <Smile />
                                        <p>Paula R</p>
                                ...
                                <div className="flex flex-col justify-between gap-5 rounded-3xl bg-yellow-200 p-6 shadow-sm drop-shadow-lg md:col-span-2 xl:col-span-1">
                                    <p>
                                        Amo la personalidad de la Jedah para
                                        todo, estoy con ella en el mami squad y
                                        en el reading club y espero los días que
                                        nos juntamos. Es un relajo para mi, que
                                        podamos hablar, descargarnos y todo en
                                        ingles. A veces se me olvida que la
                                        Jedah es la profe hasta que me corrige
                                        una palabra jajaja. Pero eso, si estan
                                        buscando alguien que les de confianza,
                                        es la Jedah. Quiero recomendar
                                        especialmente el mami squad, no es solo
                                        un acompañamiento para que le ayudemos a
                                        nuestros bebes a hablar inglés, es
                                        tambien una comunidad de personas que
                                        está para ti en todo.
                                    </p>
                                    <div className="flex flex-row gap-5">
                                        <Smile />
                                        <p>Camila A</p>
